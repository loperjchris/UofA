 ...
 * animal.setIsAlive();
 * animal.getIsAlive();
 * animal.getTotalMoves();
 * animal.increaseTotalMoves();
 * animal.getMovesSinceEaten();
 * animal.increaseMovesSinceEaten():
 * animal.resetMovesSinceEaten();
 * animal.toString();
 */
public class Animal {
    ...
    // Sets isAlive to false to kill animal.
    ...
    // Getter method for totalMoves.
    public int getTotalMoves() {
        return totalMoves;
    }

    // Increases totalMoves by 1.
    public void increaseTotalMoves() {
        totalMoves++;
    }

    // Getter method for movesSinceEaten.
    public int getMovesSinceEaten() {
        return movesSinceEaten;
    }

    // Increases movesSinceEaten by 1.
    public void increaseMovesSinceEaten() {
        movesSinceEaten++;
    }

    // Sets movesSinceEaten to 0.
