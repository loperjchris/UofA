...
def get_configs():
    return {
        ...
        'a6': [Program("abundance.py", post_process="sort"), Program("biodiversity.py", post_process="sort"), Program("rhymes-oo.py", post_process="sort,uniq")],
