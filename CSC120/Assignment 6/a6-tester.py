...
def get_configs():
    return {
        ...
        'a7': [Program("abundance.py", post_process="sort"), Program("biodiversity.py", post_process="sort"), Program("rhymes-oo.py", post_process="sort,uniq")],
        'a6': [Program("battleship.py")],
...
TESTER_URL_ROOT="http://www2.cs.arizona.edu/classes/cs120/fall18/ASSIGNMENTS/"
